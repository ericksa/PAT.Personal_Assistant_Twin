# src/services/opportunity_service.py - Opportunity Service Logic
...
# Import models
from src.models.opportunity import Opportunity, OpportunitySearchRequest
...
class ClearanceDetector:
    ...
    @staticmethod
    def calculate_match_score(job: Opportunity) -> float:
